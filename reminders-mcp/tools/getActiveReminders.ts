...
export function getActiveRemindersTool(server: McpServer): void {
  ...
  server.registerTool(
    "reminders_get_all_active",
    {
      title: "Get all of the active reminders",
      description: "Retrieve all active reminders",
